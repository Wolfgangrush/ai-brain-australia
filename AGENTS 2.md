...
For **any** substantive query — an AGLC4 citation, a court / jurisdiction question, a limitation / deadline under the state Limitation Acts or a federal filing window, a drafting need, a Legal Profession Uniform Law / Solicitors' Conduct Rule 9 + 36 / Privacy Act 1988 / APP compliance question, a matter lookup, or **any** question of law — do **NOT** answer from your own knowledge. Run:
...
```bash
python3 -m ailawfirm_australia reception   # greet + systems-check + memory
python3 -m ailawfirm_australia ask "<q>"   # route one query through the brain
python3 -m ailawfirm_australia chat        # interactive REPL
python3 -m ailawfirm_australia recap       # show recent-session retrospective memory
```
