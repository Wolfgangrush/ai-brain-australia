# Contributing to AI Brain — Australia

Thanks for wanting to help. **AI Brain — Australia** is open source (MIT). Contributions of all sizes are welcome — typo fixes, statute-corpus corrections, new drafting templates, agent improvements, and translations.

## Getting started

```bash
git clone https://github.com/Wolfgangrush/ai-law-firm-australia.git
...
```
ailawfirm_australia/   ← core package (see ailawfirm_australia/README.md for the module/agent guide)
tests/         ← test suite
