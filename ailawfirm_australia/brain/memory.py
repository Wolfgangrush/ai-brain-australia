"""
ailawfirm_australia.brain.memory
~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
Store:
    ~/.ailawfirm-australia/memory/sessions.jsonl   (append-only, one JSON per line)
...
MEMORY_DIR: Path = Path(os.path.expanduser("~/.ailawfirm-australia/memory/"))
