"""ailawfirm_australia.brain.repl — terminal front door for the brain.

A small, dependency-free Read–Eval–Print Loop that talks to the brain's
:class:`ailawfirm_australia.brain.router.think` function. The user types a
...
_BANNER = (
    "ailawfirm_australia brain — terminal front door\n"
