...
**Version:** 0.1.1 · **License:** MIT · **Publisher:** [wolfgang_rush](https://github.com/Wolfgangrush) — an Indian advocate (High Courts of India, India). NOT admitted in any Australian jurisdiction. This is a software publication for Australian-admitted practitioners. · **Engine:** Built on a local memory architecture
...
- **Engine — all architectural credit:** a local memory architecture — the highest-scoring open-source AI memory system ever benchmarked. MIT licensed. We are a downstream fork specialized for Australian solo practice.
